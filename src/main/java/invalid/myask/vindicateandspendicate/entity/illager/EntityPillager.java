...
public class EntityPillager extends EntityMob implements IEntityOwnable, IRangedAttackMob {
    ...
    private void setCombatStrategy() {
        ...
        else tasks.addTask(2, GETIN_ATTACK);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase pincushion, float num) {
        ...
        if (getHeldItem().attemptDamageItem(1, rand)) setCombatStrategy();
    }
