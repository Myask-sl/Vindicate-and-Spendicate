...
public class ItemXBow extends Item implements VindicItem {
    ...
    public void registerIcons(IIconRegister register) {
        ...
        if (iconArrow == null) {
            iconArrow = register.registerIcon(VindicateAndSpendicate.MODID + ":crossbow_arrow");
            iconSpectralArrow = register.registerIcon(VindicateAndSpendicate.MODID + ":crossbow_spectral_arrow");
            iconTippedArrow = register.registerIcon(VindicateAndSpendicate.MODID + ":crossbow_tipped_arrow");
            iconRocket = register.registerIcon(VindicateAndSpendicate.MODID + ":crossbow_fireworks");
            iconBlank = register.registerIcon(VindicateAndSpendicate.MODID + ":blank");
        }
    }
}
